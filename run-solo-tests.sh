...
sbt clean -Dbrowser="chrome" -Denvironment="local" -Dbrowser.option.headless=false -Dbrowser.usePreviousVersion=false "testOnly uk.gov.hmrc.ui.specs.* -- -n SoloTests" testReport