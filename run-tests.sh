...
sbt clean -Dbrowser="chrome" -Denvironment="local" -Dbrowser.option.headless=true -Dbrowser.usePreviousVersion=false "testOnly uk.gov.hmrc.ui.specs.* -- -n AcceptanceTests" testReport